...
# ฟังก์ชันแสดงเมนูจัดการ 3X-UI ภาษาไทย และส่งต่อไปยังระบบหลักของต้นฉบับ
show_menu() {
    clear
    echo -e "--------------------------------------------------------"
    ...
    case $choice in
        ...
        1)
            ...
            ;;
        [2-28])
            # ส่งหมายเลขเมนูที่เลือกไปยังสคริปต์หลักของโปรเจกต์ เพื่อรันฟังก์ชันนั้นๆ ได้ทันทีอย่างสมบูรณ์
            bash <(curl -Ls https://raw.githubusercontent.com/mhsanaei/3x-ui/main/install.sh)
            ;;
        *)
